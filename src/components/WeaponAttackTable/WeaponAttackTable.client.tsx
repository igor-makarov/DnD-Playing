...
import type { Props } from "./WeaponAttackTable.server";
import WeaponSelector from "./WeaponSelector";
import { type WeaponState, computeTotalDamage, weaponReducer } from "./weaponAttackReducer";

export default function WeaponAttackTableClient({ weaponAttacks, damageAddons }: Props) {
    ...
    <table>
      <tbody>
        ...
        {damageAddons.map((addon) => (
          <AddonRow key={addon.name} addon={addon} state={state} dispatch={dispatch} />
        ))}
