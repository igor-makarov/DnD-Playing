...
class VaelusCharacter extends Character {
  constructor() {
    super({
      abilityScores: {
        Str: 17,
      ...
      skillProficiencies: [{ skill: "Religion" }, { skill: "Insight" }],
      saveProficiencies: [
        { save: "Wis" }, // Paladin
        { save: "Cha" }, // Paladin
      ],
  ...
  getWeapons(): Weapon[] {
    return [{ weapon: "Censer (Flail)", ability: "Str", damage: new DiceString("d8") }];
  }
...
const character = new VaelusCharacter();
const characterName = "Vaelus";
...
export default function VaelusPage() {
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="modifier">
                  <InfoTooltip reference={speciesRef}>Elf</InfoTooltip> (Mournvale)
                </td>
              </tr>
              <tr>
                <td>Class</td>
                <td className="modifier">
                  <InfoTooltip reference={classRef}>Paladin</InfoTooltip> 3 (Oath of Vengeance)
                </td>
              </tr>
              <tr>
                <td>[Elf] Darkvision</td>
                <td className="modifier">60 ft.</td>
              </tr>
              <tr>
                <td>[Elf] Fey Ancestry</td>
                <td className="modifier">adv. vs charmed</td>
              </tr>
              <tr>
                <td>[Elf] Keen Senses</td>
                <td className="modifier">Perception proficiency</td>
              </tr>
              <tr>
                <td>[Elf] Trance</td>
                <td className="modifier">4 hour long rest</td>
              </tr>
              <tr>
                <td>[Elf] Necrotic Resistance</td>
                <td className="modifier">resist necrotic</td>
              </tr>
              <tr>
                <td>[Elf] Deathless</td>
                <td className="modifier">Aramán homebrew</td>
              </tr>
              <tr>
                <td>[Feat] Magic Initiate (Cleric)</td>
                <td className="modifier">cleric cantrips & spell</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>[Vengeance] Vow of Enmity</td>
                <td className="modifier">adv. vs one creature</td>
              </tr>
            </tbody>
          </table>
          <table>
            <tbody>
              ...
              <tr>
                <td colSpan={2}> Sisters of Sylandri </td>
              </tr>
            </tbody>
          </table>
        </div>
